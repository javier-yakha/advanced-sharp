    ...
    public static class DBManager
    {
        ...
        public static void InitializeCourses(NonDB DB)
        {
            ...
            [
                ...
                new Course("Complexity of Bogo sort"),
                new Course("How to use Edge to install an actual good browser"),
                new Course("Docker & Roller"),
                new Course("Advanced Keyboard Typing"),
                new Course("Introduction to google search"),
                new Course("How to set up a Cloud service while skydiving 101")
            ];
